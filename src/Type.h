...
struct vec2
{
	...
	friend vec2 operator * (float f, const vec2 &other)	{
		return other*f;
	}
...
struct vec3
{
	...
	friend vec3 operator * (float f, const vec3 &other)	{
		return other*f;
	}
...
struct rgba
{
	...
	rgba(float r1, float g1, float b1)			{
		r=r1;
		g=g1;
		b=b1;
		a=1.0f;
	}
	rgba(float r1, float g1, float b1, float a1)	{
		r=r1;
		g=g1;
		b=b1;
		a=a1;
	...
	friend rgba operator * (float f, const rgba &other)	{
		return other*f;
	}
